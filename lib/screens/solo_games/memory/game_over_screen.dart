...
class MemoryGameOver extends StatefulWidget {
  ...
  @override
  State<MemoryGameOver> createState() => _MemoryGameOverState();
}

class _MemoryGameOverState extends State<MemoryGameOver> {
  @override
    ...
    return Scaffold(
      body: Column(
        children: [
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/memory-cards.png"),
                        fit: BoxFit.contain,
                      ),
          ...
          _getRadialGauge(widget.memoryPoints),
          const Spacer(),
          ElevatedButton(
            style: ButtonStyle(
