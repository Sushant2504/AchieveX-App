...
const int _TotalQuestions = 90;
int _QuestionNumber = 1;
int _answered = 0;
int _notanswered = 90;
int _CorrectAnswered = 0;
int _NotCorrectAnswered = 0;
int _IncorrectAnswered = _TotalQuestions - _CorrectAnswered;
int todolater = 0;
late int minutes;
late int seconds;
...
class FullJeeMainExam extends StatefulWidget {
  ...
  const FullJeeMainExam({super.key, required this.Set});
...
class _FullJeeMainExamState extends State<FullJeeMainExam> {
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Fulltestjeemainresult(
                              paper: widget.Set,
  ...
  Widget _countdown(Color bgcolor, Color color) {
    return Padding(
