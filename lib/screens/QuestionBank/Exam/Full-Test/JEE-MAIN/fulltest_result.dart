...
class Fulltestjeemainresult extends StatefulWidget {
  ...
  const Fulltestjeemainresult({super.key, 
    required this.paper,
  ...
  @override
  _FulltestjeemainresultState createState() => _FulltestjeemainresultState();
}



class _FulltestjeemainresultState extends State<Fulltestjeemainresult> {
  @override
  Widget build(BuildContext context) {
    ...
    Map<String, int> rankrange = getRankRange(widget.marks.toDouble(), PreviousYearsData.Percentiles);
    RangeValues currentRangeValues = RangeValues(rankrange['lowerBoundRank']!.toDouble(),  rankrange['upperBoundRank']!.toDouble());
                  ...
                  InkWell(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  const YearNamesScreen(exam: "jeemain")),
                        );
                      },
