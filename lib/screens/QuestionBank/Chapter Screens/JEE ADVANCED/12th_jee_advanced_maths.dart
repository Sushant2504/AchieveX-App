...
class SubjectjeeadvancedfiveScreen extends StatefulWidget {
  const SubjectjeeadvancedfiveScreen({super.key});

 
  @override
  _SubjectjeeadvancedfiveScreenState createState() => _SubjectjeeadvancedfiveScreenState();
}

class _SubjectjeeadvancedfiveScreenState extends State<SubjectjeeadvancedfiveScreen> {
  var global_index = 0;
