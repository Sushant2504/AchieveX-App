...
String subsubject = "Topic Wise PYQs";
  ...
  void SelectScreen(int index) {
    switch (index) {
      case 1:
       Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const SubjectneetthreeScreen()),
        );
        break;
      case 2:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const SubjectneettwoScreen()),
        );
      ...
      case 3:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const SubjectneetoneScreen()),
        );
      ...
      case 4:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const FullTestNames()),
        );
        break;
  ...
  void showMyAlertDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          content: const Text('Firstally Choose the Subject to proceed!'),
          actions: [
            TextButton(
              onPressed: () {
