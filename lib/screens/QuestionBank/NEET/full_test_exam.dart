...
import 'full_test_neet_result.dart';
...
class FullNeetExam extends StatefulWidget {
  @override
  _FullNeetExamExamState createState() => _FullNeetExamExamState();
}

class _FullNeetExamExamState extends State<FullNeetExam> {
  @override
      ...
      child: Container(
        ...
        child: Countdown(
          ...
          onFinished: (dynamic time) {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => fulltestneetresult()),
            );
          },
        ),
      ),
