...
import 'package:achievex/screens/chess_game/views/components/shared/text_variable.dart';
...
class MoveList extends StatelessWidget {
  ...
  String _moveToString(MoveMeta meta) {
    ...
    if (meta.kingCastle) {
      ...
      move =
          '${_pieceToChar(meta.type ?? ChessPieceType.promotion)}$ambiguity$takeString' '$col$row$promotion';
    }
